...
lm.utils.copy(lm.controls.Header.prototype, {
  ...
  setActiveContentItem: function (contentItem) {
    ...
    if (this.layoutManager.config.settings.reorderOnTabMenuClick) {
      ...
      if (this._lastVisibleTabIndex !== -1 && this.parent.config.activeItemIndex > this._lastVisibleTabIndex) {
        ...
        for (var j = this.parent.config.activeItemIndex; j > 0; j--) {
  ...
  _createControls: function () {
     ...
     */
    var showTabDropdown = lm.utils.fnBind(this._showAdditionalTabsDropdown, this)
    var tabDropdownLabel = this.layoutManager.config.labels.tabDropdown
    ...
    if (this._getHeaderSetting('popout')) {
      ...
      new lm.controls.HeaderButton(this, label, 'lm_popout', popout) // eslint-disable-line no-new
    }
  ...
  _updateTabSizes: function (showTabMenu) {
    ...
    var overlap = 0
    var tabWidth
    var tabOverlapAllowance = this.layoutManager.config.settings.tabOverlapAllowance
    var tabOverlapAllowanceExceeded = false
    var activeIndex = (this.activeContentItem ? this.tabs.indexOf(this.activeContentItem.tab) : 0)
