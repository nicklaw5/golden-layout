$(function () {
  ...
  window.myLayout = new GoldenLayout(config) // eslint-disable-line

  var rotate = function (container) {
    if (!container) return
    while (container.parent && container.type !== 'stack') { container = container.parent }
    if (container.parent) {
